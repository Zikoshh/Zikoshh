...
<p align="left">Я решил стать разработчиком потому что я люблю копаться в чем-то и с детства любил фильмы про хакеров. 

Почему Frontend? — Вообще изначально хотел в GameDev, но передумал, т.к C++ сложен для новичков. Поэтому выбор пал на Js и Frontend. По мере изучения стека фронтенда мне все больше начал нравится Frontend.

Хочу написать крутые продукты с хорошей оптимизацией и лучшим UX. На данный момент усиливаю свои знания в React и Js. 

Смотрю изредка стримеров по фронтенду. Например: siberiacancode (Твич: https://www.twitch.tv/siberiacancode), JoinTime (Твич: https://www.twitch.tv/jointime).
</p>
